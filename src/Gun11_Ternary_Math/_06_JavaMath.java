...
public class _06_JavaMath {
    public static void main(String[] args) {
        ...
        System.out.println("a nın mutlak degeri =" + Math.abs(a)); //12 absolute mutlak Pozitife çeviriyor.
        ...
        System.out.println("round 3.1=" + Math.round(3.1));// 3   0,5 altını alt tam sayıya eşitliyor
        System.out.println("round 3.5="+Math.round(3.5));//4      0,5 ve üzerini üst tam sayıya eşitliyor.
